  ...
  return (
    ...
    >
      <div className="flex items-start gap-3">
        <div className="flex h-12 w-12 shrink-0 items-center justify-center rounded-xl border border-white/10 bg-gradient-to-br from-violet-500/20 to-sky-500/10 text-2xl">
          {product.emoji || '📦'}
        </div>
      ...
      <div className="mt-4 grid grid-cols-2 gap-2 text-sm">
        <div className="rounded-xl bg-white/[0.04] px-3 py-2">
          <p className="text-[10px] uppercase tracking-wide text-slate-500">Precio venta</p>
        ...
        <div className="rounded-xl bg-white/[0.04] px-3 py-2">
          ...
          <p className="font-semibold text-slate-300">{formatMoney(product.cost)}</p>
        </div>
        <div className="rounded-xl bg-white/[0.04] px-3 py-2">
        ...
        <div className="rounded-xl bg-white/[0.04] px-3 py-2">
          <p className="text-[10px] uppercase tracking-wide text-slate-500">Margen</p>
